...
- **[Before You Fix Your Data, Understand It (Forest Cover Type)](/blog/forest-cover-type-prediction)** — cartographic features, sanity checks, and why "weird values" often mean geography rather than bad data.
- **[Bike-Sharing Demand Forecasting](/blog/bike-sharing-demand)** — hourly demand in Washington, D.C., with cyclic time encodings and time-aware cross-validation.

## Resources

<ul className="post-links post-links--prominent">
  <li>
    <a href="https://maria-aguilera.github.io/projects/spaceship-titanic.html" target="_blank" rel="noopener noreferrer">
  ...
  <li>
    <a href="https://github.com/maria-aguilera/spaceship-titanic" target="_blank" rel="noopener noreferrer">
  ...
  <li>
    <a href="https://colab.research.google.com/drive/1GgTDc8bqNdoxLfQ9bRVZQ1OFKEhcYz4x" target="_blank" rel="noopener noreferrer">
