...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-qa-vs-information-retrieval.png"
  alt="Comparison between information retrieval and question answering: IR returns ranked documents, while QA returns a direct answer."
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-narrow-the-domain.png"
  alt="Funnel showing that question answering gets easier as the domain narrows from any topic to company documents to a specific product manual."
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-two-qa-paradigms.png"
  alt="Two question answering paradigms: IR-based systems and knowledge-based systems both feed answer extraction."
  caption="The main difference is where the candidate answers come from."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-classical-qa-pipeline.png"
  alt="Classical question answering pipeline from question processing to IR, passage retrieval, answer processing, and final answer."
  caption="Classical QA is a chain of modules, and each module can introduce errors."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-answer-type-taxonomy.png"
  alt="Answer type taxonomy with coarse question classes and fine-grained answer types."
  caption="Answer type detection tells the rest of the system what kind of answer to search for."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-passage-retrieval.png"
  alt="Passage retrieval diagram that splits a long article into candidate passages and highlights the top-scoring candidate."
  caption="Passage retrieval turns whole documents into smaller answer candidates."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-single-neural-net.png"
  alt="Classical QA modules replaced by a single neural network between the input question and the answer."
  caption="Deep learning compresses the hand-built pipeline into one learned model."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-qa-lstm-attention.png"
  alt="QA LSTM with attention using story, question, and answer inputs, embeddings, LSTMs, attention links, and a dense output layer."
  caption="Attention lets the model connect the question to the relevant facts and candidate answer."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-bert-start-end-heads.png"
  alt="BERT-based question answering with start and end probability heads over the input tokens."
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-knowledge-base-graph.png"
  alt="Knowledge base represented as an entity-relation graph, with facts attached to connected entities."
  caption="Knowledge-based QA queries structured facts instead of raw text passages."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-semantic-parsing.png"
  alt="Semantic parsing model that translates a natural-language question into a structured knowledge-base query."
  caption="Semantic parsing translates natural language into something the knowledge base can execute."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-hybrid-watson-reasoning.png"
  alt="Hybrid Watson-style reasoning example combining temporal reasoning, paraphrase matching, and geospatial lookup to answer Vasco da Gama."
  caption="Hybrid QA combines retrieved evidence, language matching, and structured reasoning."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-bert-qa-caution.png"
  alt="BERT QA caution showing that a fluent answer can be linguistically correct but factually wrong."
  caption="Linguistically plausible is not the same as factually correct."
/>
...
<Image
  src="/images/blog/nlp-from-scratch/question-answering/inline-gpt-zero-shot-qa.png"
  alt="GPT-style zero-shot question answering where a prompt goes into a large model and returns a generated answer."
  caption="Zero-shot QA turns the task into a prompt, but the same correctness risks remain."
/>
