...
- **[When Missing Values Aren't Random (Spaceship Titanic)](/blog/spaceship-titanic)** — relational imputation from PassengerID and Cabin schemas, plus a 10-model bake-off.
