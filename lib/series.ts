...
export const series: Series[] = [
  ...
  },
  {
    ...
    posts: [
      ...
      { part:  4, title: "The 4-page cheatsheet",                          slug: "genai-interview-prep-cheatsheet",             published: true  },
      { part:  5, title: "LLM Foundations — transformers, RLHF, sampling", slug: "genai-01-llm-foundations",                    published: true  },
      { part:  6, title: "Prompting & Reasoning Loops",                    slug: "genai-02-prompting-reasoning",                published: true  },
      { part:  7, title: "RAG & Retrieval Deep Dive",                      slug: "genai-03-rag-retrieval",                      published: true  },
      { part:  8, title: "Memory & State Management",                      slug: "genai-04-memory-state",                       published: true  },
      { part:  9, title: "Multi-Agent Systems & Tool Use",                 slug: "genai-05-multi-agent-tools",                  published: true  },
      { part: 10, title: "Guardrails, Security & LLMOps",                  slug: "genai-06-guardrails-security-llmops",         published: true  },
      { part: 11, title: "Cost, Latency & Deployment",                     slug: "genai-07-cost-latency-deployment",            published: true  },
      { part: 12, title: "Language Modeling — the LLM foundation",         slug: "nlp-from-scratch-05-language-modeling",       published: true  },
      { part: 13, title: "Text Classification — Deep Learning",            slug: "nlp-from-scratch-07-text-classification-dl",  published: true  },
      { part: 14, title: "Information Retrieval — the R in RAG",           slug: "nlp-from-scratch-08-information-retrieval",   published: true  },
      { part: 15, title: "Question Answering — LLM pipelines",             slug: "nlp-from-scratch-09-question-answering",      published: true  },
    ],
  },
];
